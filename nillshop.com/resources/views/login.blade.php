...
<div class="container">
    ...
    <form class="form-signin" method="POST" action="{{route('login')}}">
        ...
        <input type="email" name="id" id="id" class="form-control" placeholder="Email address" required autofocus style="border-radius: 20px;margin-bottom:5px">
        <input type="password" name="password" id="password" class="form-control" placeholder="Password" required style="border-radius: 20px;">
        <div class="checkbox">
            <label>
                <input type="checkbox" value="1" name="remember_me"> 記住我
            </label>
        </div>
